...
YANG_YANG   := $(filter-out $(SUBMODULES),$(wildcard yang/*.yang))
...
YANG_STATS  += $(filter tailf-%-stats.yang ietf-%.yang,$(YANG))
...
tmp-yang/fxs-config: $(call y,$(YANG_CONFIG))
	...
	cp $(call ty,$(YANG_CONFIG)) $(YANG_ID_LEGACY) $(call ty,$(YANG_SUBS)) tmp-yang/config
